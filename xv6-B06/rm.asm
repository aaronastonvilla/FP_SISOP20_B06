...
main(int argc, char *argv[])
{
  ...
  51:	50                   	push   %eax
  52:	e8 53 04 00 00       	call   4aa <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5c4:	0f b6 91 a0 13 00 00 	movzbl 0x13a0(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 702:	75 25                	jne    729 <printf+0x103>
          s = "(null)";
 704:	c7 45 f4 6e 0f 00 00 	movl   $0xf6e,-0xc(%ebp)
        while(*s != 0){
